...
const Hero = () => {
  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center relative z-10 ">
      ...
      {/* left-section */}
      <section className="w-full max-w-6xl flex flex-col-reverse md:flex-row justify-center items-start text-start pl-6 md:pl-28 ">
        <div
          ref={containerRef}
          className="z-30 relative sm:px-0 xl:px-4 py-12 max-w-5xl w-full flex flex-col items-start justify-start text-center"
        >
          {/* Title */}
          <GlitchRevealText
            text="Abhishek"
          ...
          <GlitchRevealText
            ...
            className="text-xl sm:text-2xl md:text-[26px] font-semibold"
          ...
          <div className="hidden xl:block text-start">
            ...
            <ScanlineTextOverlay
              ...
              className="text-base sm:text-lg md:-mt-2 max-w-xl text-gray-600 dark:text-gray-300"
              delay={0.79}
              duration={0.8}
              textColor="#000"
            />
          ...
          <div className="block xl:hidden">
            <ScanlineTextOverlay
              text="I’m a MERN stack developer with a strong grasp of DSA, system design, and real-world applications that deliver impact."
              className="text-base sm:text-lg max-w-xl text-gray-600 dark:text-gray-300 text-justify tracking-wide"
              delay={0.69}
              duration={0.7}
              textColor="#000"
            />
          ...
          >
            ...
            className="group bg-black text-white cursor-pointer px-6 py-2 rounded-full text-base sm:text-lg font-semibold shadow-lg transition-transform duration-300 hover:scale-105 relative overflow-hidden">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='relative md:ml-3 sm:mr-5 md:mr-18 xl:mr-35 mx- md:-mt-28 lg:-mt-36 
                    w-[180px] h-[180px] sm:w-[250px] sm:h-[250px] md:w-[405px] md:h-[440px] 
                    overflow-hidden rounded-full group shadow-lg ml-6'
        >
          <motion.div
            animate={{
              scale: [1, 1.02, 1],
